...
/*
  ...
  $_REQUEST - Contains information about varibles passed through the form or URL
  */
  ?>
  ...
  <body>
    <ul>
      ...
      <li>Rewuest URI: <?php echo $_SERVER['REQUEST_URI']; ?></li>
      <li>Server Software: <?php echo $_SERVER['SERVER_SOFTWARE']; ?></li>
      <li>Client Info: <?php echo $_SERVER['HTTP_USER_AGENT'];?></li>
      <li>Remote Address: <?php echo $_SERVER['REMOTE_PORT'];?></li>
